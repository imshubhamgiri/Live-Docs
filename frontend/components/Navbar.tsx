    ...
    return (
      <header className="sticky top-0 z-40 h-15.25 shrink-0 box-border bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 py-3.5 flex items-center justify-between">
        <div 
          ...
          className="flex flex-col items-center justify-center py-1 lg:flex-row  space-x-2.5 cursor-pointer group"
        >
        ...
        <nav className="hidden md:flex md:space-x-3 items-center lg:space-x-8 text-sm font-medium text-slate-600">
        ...
        <div className="flex items-center  gap-1 lg:space-x-3">
          {appState === 'chat' && (
            <button 
              onClick={onResetToHome}
              className="flex items-center gap-1.5 px-3 hidden md:block py-1.5 rounded-lg border border-slate-300 bg-white text-xs font-semibold text-slate-700 hover:bg-slate-50 shadow-sm transition-all"
            >
